    ...
    (0, _createClass3.default)(Virtualize, [{
      ...
      value: function setIndex(index, indexContainer, indexDiff) {
        ...
        this.setState(nextState, function () {
          _this2.setWindowTimer();
        });
      }
    }, {
      key: 'setWindowTimer',
      value: function setWindowTimer() {
        var _this3 = this;
      ...
      value: function render() {
        ...
        var indexProp = _props.index;
        var onChangeIndex = _props.onChangeIndex;
        var overscanSlideCount = _props.overscanSlideCount;
        var slideCount = _props.slideCount;
        var slideRenderer = _props.slideRenderer;
        var other = (0, _objectWithoutProperties3.default)(_props, ['children', 'index', 'onChangeIndex', 'overscanSlideCount', 'slideCount', 'slideRenderer']);
        var _state = this.state;
        var indexContainer = _state.indexContainer;
        var indexStart = _state.indexStart;
        var indexStop = _state.indexStop;


        var slides = [];

        for (var slideIndex = indexStart; slideIndex <= indexStop; slideIndex++) {
